...
public class EmpController {
	...
	/**
	 * Permet d'afficher la page /WEB-INF/vues/empform.jsp. L'objet qui est passé
	 * dans la requête est "employe" de type la classe EmpVo. Les attributs de
	 * l'objet "employe" seront accessibles au niveau de la page moyennant les
	 ...
	 * passés dans l'objet EmpVo. Ici, il faut préciser que la méthode HTTP est bien
	 * POST car la méthode par défaut est GET.
	 * 
	 ...
	 * /WEB-INF/vues/viewemp.jsp sera affichée. La liste des employées est placée
	 * dans le Model.
	 */
	 ...
	 * /WEB-INF/vues/empeditform.jsp sera affichée. L'objet EmpVo est placé dans le
	 * Model.
	 */
